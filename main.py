...
from base.old_func.func_report_reminder import ReportReminder
...
def main(chat_type: int):
    ...
    vxrobot = VX_Robot(config, wcf, chat_type)
    vxrobot.LOG.info(f"Omnis Ai Hub >>【{__core__}】成功启动···")
    ...
    # # 每天 7 点发送天气预报
    # vxrobot.onEveryTime("07:00", robot.weatherReport)

    # # 每天 7:30 发送新闻
    # vxrobot.onEveryTime("07:30", robot.newsReport)

    # # 每天 16:30 提醒发日报周报月报
    # vxrobot.onEveryTime("16:30", ReportReminder.remind, robot=robot)

    # 让机器人一直跑
    vxrobot.keepRunningAndBlockProcess()
